...
export function Hero() {
  ...
  return (
    <section
      id="start"
      ref={ref}
      className="relative min-h-[100svh] w-full overflow-hidden text-foreground bg-surface"
    >
      <motion.div style={{ y }} className="absolute inset-0 z-0">
        <img
          src={heroAsset.url}
          alt="Bauleiter auf Baustelle bei Sonnenuntergang"
          loading="eager"
      ...
      <div className="container-px mx-auto max-w-7xl pt-36 md:pt-44 pb-28 md:pb-40 relative z-10">
        ...
        >
          Über 30 Jahre Erfahrung. Ein Ansprechpartner. Volle Kontrolle über Termine, Qualität und
          Kosten.
        </motion.p>
    ...
    <section id="leistungen" className="relative py-24 md:py-36 bg-surface">
      <div className="container-px mx-auto max-w-7xl">
        <SectionHeader
          ...
          title={
            <>
              Alles aus einer Hand — von der ersten Besichtigung bis zur{" "}
              <span className="text-gradient">Schlüsselübergabe</span>.
            </>
          }
            ...
            <Reveal key={l.title} delay={i * 0.08}>
              <div className="group relative h-full overflow-hidden rounded-3xl border border-hairline bg-white p-8 transition-all duration-500 hover:-translate-y-1.5 hover:shadow-elegant">
                ...
                <div className="relative">
                  <div
                    className="inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-navy text-white transition-transform group-hover:scale-110 group-hover:rotate-3"
...
const VORTEILE = [
  {
    ...
    text: "Praxiswissen aus hunderten Baustellen, Sanierungen und Umbauprojekten.",
  },
  {
    icon: Handshake,
    title: "Ein Ansprechpartner",
    text: "Vom ersten Telefonat bis zur Schlüsselübergabe – persönlich und verbindlich.",
  },
  {
    icon: Eye,
    title: "Volle Transparenz",
    text: "Fortschrittsberichte, Fotodokumentation, lückenlose Nachvollziehbarkeit.",
  },
  {
    icon: Wallet,
    title: "Kostenkontrolle",
    text: "Angebote, Nachträge und Rechnungen werden fachkundig vor Freigabe geprüft.",
  },
  {
    icon: ShieldCheck,
    title: "Qualitätskontrolle",
    text: "Kontinuierliche Prüfung auf Verarbeitung, Materialien und Regeln der Technik.",
  },
  {
    icon: Clock,
    title: "Terminsicherheit",
    text: "Strukturierte Ablaufplanung und konsequente Steuerung aller Gewerke.",
  },
  {
    icon: Sparkles,
    title: "Flexible Projektbetreuung",
    text: "Aktivieren Sie unsere Leistung nur dann, wenn Sie sie wirklich brauchen.",
  },
  {
    icon: Compass,
    title: "Unabhängige Bauleitung",
    text: "Ausschließlich auf Ihrer Seite – ohne wirtschaftliche Verbindung zu Handwerksfirmen.",
  },
];
      ...
      <div className="container-px mx-auto max-w-7xl grid gap-16 lg:grid-cols-2 lg:items-center">
        <Reveal>
          <div className="relative">
            ...
            <div className="relative overflow-hidden rounded-[2rem] border border-hairline shadow-elegant">
              <img
                src={deskAsset.url}
                alt="ERCA Bauleitung – Planung und Kontrolle"
        ...
        <div>
          <SectionHeader
            ...
            title={
              <>
                Erfahrung, die Ihr Projekt <span className="text-gradient">schützt</span>.
              </>
            }
          />
          <Reveal delay={0.12}>
          ...
          <Reveal delay={0.18}>
            <p className="mt-6 text-lg text-foreground/80 leading-relaxed">
              ERCA Bauleitung steht für etwas, das sich nicht zertifizieren lässt: über drei
              Jahrzehnte Praxis im Bau-, Technik- und Sanierungsbereich. Wir kennen die Fragen, die
              auf einer Baustelle wirklich entstehen — weil wir sie selbst gelöst haben.
            </p>
          </Reveal>
          <Reveal delay={0.25}>
            <p className="mt-5 text-base text-muted-foreground leading-relaxed">
              Wir sprechen die Sprache der Baustelle — und gleichzeitig die Sprache des
              Auftraggebers. Klare Ansagen statt endloser Berichte. Ein Ansprechpartner vom ersten
              Telefonat bis zur Schlüsselübergabe.
            </p>
          </Reveal>
          <Reveal delay={0.35}>
  ...
  const items = [
    {
      ...
      text: "Ein Ansprechpartner über die gesamte Projektlaufzeit.",
    },
    {
      icon: HardHat,
      title: "Praxiserfahrung",
      text: "Wissen aus echten Baustellen, nicht aus Schulungen.",
    },
    {
      icon: Eye,
      title: "Transparente Kommunikation",
      text: "Klare Berichte, faire Aussagen, keine Schönfärberei.",
    },
    {
      icon: ShieldCheck,
      title: "Unabhängige Kontrolle",
      text: "Wir stehen ausschließlich auf Ihrer Seite.",
    },
    {
      icon: Building2,
      title: "Schutz vor teuren Fehlern",
      text: "Frühzeitige Erkennung von Risiken bevor Kosten entstehen.",
    },
  ];
  return (
    <section className="relative py-24 md:py-36 bg-surface overflow-hidden">
      <div
        aria-hidden
        className="absolute inset-x-0 -top-40 h-[500px]"
        style={{
          background:
            "radial-gradient(ellipse at center, color-mix(in oklab, var(--teal) 18%, transparent), transparent 70%)",
        }}
      />
...
const FAQS = [
  {
    q: "Wann lohnt sich ein externer Bauleiter?",
    a: "Immer dann, wenn Sie keine eigene Bauleitung im Haus haben, aber dennoch professionelle Kontrolle über Termine, Qualität und Kosten benötigen. Besonders bei Sanierungen, Modernisierungen, Leerwohnungssanierungen und Umbauprojekten ist ein externer Bauleiter wirtschaftlicher als eine Festanstellung.",
  },
  {
    q: "Was kostet eine Bauleitung?",
    a: "Die Vergütung erfolgt projektbezogen — entweder als prozentualer Anteil der Bausumme oder als Pauschale, abhängig von Umfang und Komplexität. Sie zahlen nur das, was tatsächlich erbracht wird. Keine Sozialabgaben, keine Fixkosten.",
  },
  {
    q: "Für welche Projekte eignet sich ERCA?",
    a: "Sanierungen, Modernisierungen, Umbauten, Neubauten, Leerwohnungssanierungen, Mehrfamilienhäuser und gewerbliche Objekte. Wir begleiten Eigentümer, Hausverwaltungen, Bauträger und Immobilieninvestoren.",
  },
  {
    q: "Wie läuft die Zusammenarbeit ab?",
    a: "Nach einem unverbindlichen Erstgespräch besichtigen wir das Objekt, entwickeln ein Maßnahmenkonzept und übernehmen anschließend die vollständige Bauleitung. Sie bleiben informiert, ohne sich um Detailprobleme kümmern zu müssen.",
  },
  {
    q: "Werden auch Hausverwaltungen betreut?",
    a: "Ja. Für Hausverwaltungen übernehmen wir die Bauleitung bei Leerwohnungssanierungen und Modernisierungsmaßnahmen — inklusive Eigentümerdokumentation und Berichterstattung.",
  },
  {
    q: "Werden Handwerker koordiniert?",
    a: "Vollständig. Wir steuern alle Gewerke aus einer Hand: Maler, Trockenbau, Fliesen, Boden, Elektro, Sanitär, Heizung, Fenster, Innenausbau und Rückbau. Die Handwerker sprechen mit uns, nicht mit Ihnen.",
  },
  {
    q: "Gibt es regelmäßige Berichte?",
    a: "Ja. Sie erhalten regelmäßige Fortschrittsberichte, Fotodokumentationen und Baustellenprotokolle. Auf Wunsch in einem festen Rhythmus oder ereignisbezogen.",
  },
  {
    q: "Wie erfolgt die Qualitätskontrolle?",
    a: "Durch laufende Baustellenbegehungen, dokumentierte Qualitätsprüfungen, Mängelprotokolle und konsequente Nachkontrollen. Rechnungen werden erst nach Prüfung der erbrachten Leistung freigegeben.",
  },
];
    ...
    <section id="faq" className="relative py-24 md:py-36">
      <div className="container-px mx-auto max-w-5xl">
        <div className="text-center">
          <SectionHeader kicker="FAQ" title={<>Häufig gestellte Fragen.</>} />
        </div>
          ...
          {FAQS.map((f, i) => {
            ...
            return (
              <Reveal key={f.q} delay={i * 0.04}>
                <div
                  className={`rounded-2xl border transition-all ${isOpen ? "border-teal/40 bg-white shadow-soft" : "border-hairline bg-white"}`}
                >
                  <button
                  ...
                  >
                    ...
                    <span
                      className={`shrink-0 inline-flex h-9 w-9 items-center justify-center rounded-full border border-hairline transition-transform ${isOpen ? "rotate-45 bg-navy text-white border-navy" : "text-navy"}`}
                    >
...
export function Kontakt() {
  ...
  return (
    <section
      id="kontakt"
      className="relative py-24 md:py-36 bg-surface-2 text-foreground overflow-hidden"
    >
      <div
        aria-hidden
        className="absolute -top-40 -left-20 h-[500px] w-[500px] rounded-full"
        style={{
      ...
      <div
        ...
        style={{
          background: "radial-gradient(circle, oklch(0.5 0.15 250) 0%, transparent 60%)",
          opacity: 0.2,
        }}
      />
        ...
        <div>
          ...
          <Reveal delay={0.2}>
            <p className="mt-5 text-lg text-muted-foreground leading-relaxed max-w-md">
              Kostenlose und unverbindliche Erstberatung. Direkt mit Erkan Catak. Wir melden uns
          ...
          <div className="mt-10 space-y-4">
            ...
            <a href="mailto:info@ercabauleitung.de" className="flex items-center gap-4 group">
              <span className="inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-surface-2 border border-hairline text-teal group-hover:bg-teal group-hover:text-navy-deep transition-colors">
                <Mail size={20} />
              </span>
              <div>
                <div className="text-xs uppercase tracking-wider text-muted-foreground">E-Mail</div>
                <div className="font-semibold">info@ercabauleitung.de</div>
              </div>
            </a>
            <a
              href={WHATSAPP_URL}
            ...
            <div className="grid gap-5">
              ...
              <label className="flex items-start gap-3 text-sm text-muted-foreground">
                ...
                <span>
                  ...
                  <a
                    href="/datenschutz"
                    className="font-semibold text-navy underline underline-offset-2 hover:text-orange transition-colors"
                  >
              ...
              {sent && (
                <p className="text-sm text-orange">
                  Ihre Anfrage wurde notiert. Wir melden uns innerhalb von 24 Stunden.
                </p>
              )}
            </div>
          </form>
