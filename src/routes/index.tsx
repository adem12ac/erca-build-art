  ...
  head: () => ({
    meta: [
      { title: "ERCA Bauleitung – Professionelle Bauleitung für Sanierungen & Umbauten" },
      {
        name: "description",
        content:
          "Externe Bauleitung für Sanierungen, Modernisierungen und Umbauprojekte. Über 30 Jahre Erfahrung. Ein Ansprechpartner für Termine, Qualität und Kosten.",
      },
      { property: "og:title", content: "ERCA Bauleitung – Erfahrung, die Ihr Projekt schützt" },
      {
        property: "og:description",
        content:
          "Unabhängige Bauleitung für Hausverwaltungen, Investoren, Eigentümer und Bauträger.",
      },
    ],
    scripts: [
      {
